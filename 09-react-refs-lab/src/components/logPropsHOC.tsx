...
function logPropsHOC<T extends InstanceType<ComponentClass<P>> , P>(WrappedComponent: ClassComponentType<T, P > | React.FunctionComponent<P > | ExoticComponentType<T, P >) {
  class LogProps extends React.Component<P & {fRef: Ref<T>}, {}> {
